...
const Mainsection = () => {
    return (
        <>
            <div className="desktop_version relative bg-basic-white w-full  text-left text-29xl text-brand-primary font-lg-regular">
                        ...
                        <div className="flex flex-wrap items-center">
                            <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0 ">
                                ...
                                <div className="my-10 flex items-center">
                                    <a href="#"
                                        className="rounded-[34px] bg-[#38589C] w-[237px] h-14 flex flex-row items-center justify-center py-[13px] px-5 box-border text-base text-[white]">
                                        Get Started
                                    </a>
                                    <img alt="" src="http://cwc-shop.com/wp-content/uploads/2023/12/Group-1.png" className="newsideimg" />
                                    <p className="text_mini">Watch Video</p>
                                </div>
                            </div>
                            <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
                                <div className="relative">
                                    <img src="http://cwc-shop.com/wp-content/uploads/2023/12/Group-1000000830-1.png" alt=""
                                        className="w-full" />
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="shrink-0 flex flex-row items-start justify-start gap-[32px] text-11xl text-blue-grey-800">
                                    <div className="rounded-[50px] bg-[white] w-[585px] h-[500px] flex flex-col items-center justify-center">
                                        <div className="flex flex-col items-center justify-start gap-[26px]">
                                            <img className="relative w-16 h-16 object-cover" alt="" src="https://smellmeloveme.shop/wp-content/uploads/2023/12/Frame-2024.png" />
                                    ...
                                    <div className="rounded-[50px] relative bg-[white] w-[585px] h-[500px] flex flex-col items-center justify-center">
                                        <div className="flex flex-col items-center justify-start gap-[26px]">
                                            <img className="relative w-16 h-16 object-cover" alt="" src="https://smellmeloveme.shop/wp-content/uploads/2023/12/Frame-2024-1.png" />
                                            <div className="shrink-0 flex flex-col items-center justify-start gap-[32px]">
                                                <div className="shrink-0 flex flex-col items-center justify-start gap-[28px]">
                ...
                <section className="dedicated_webpage">
                    <div className="dedicated_webpage relative w-full h-[958px] text-[52px]">
                        ...
                        {/* <img className="absolute top-[0px] right-[0px] w-[579px] h-[549px] object-cover" alt=""
                            src="/public/rectangle-4314@2x.png" /> */}

                        {/* <img className="absolute bottom-[0px] left-[0px] w-[579px] h-[549px] object-contain" alt=""
                        ...
                        <div className="absolute top-[calc(50%_-_359px)] left-[calc(50%_-_720px)] w-[1440px] h-[718px]">
                            ...
                            <div className="absolute top-[52px] left-[75px] w-[523px] h-[614.6px]">
                                <img className="absolute top-[56.3px] left-[78.3px] rounded-[15.58px] w-[390.6px] h-[494.3px] object-cover"
                                    alt="" src="https://smellmeloveme.shop/wp-content/uploads/2023/12/Rectangle-3480.png" />

                                <img className="absolute top-[0px] left-[312.3px] rounded-[15.58px] w-[210.7px] h-[233.9px] object-cover" alt=""
                                    src="https://smellmeloveme.shop/wp-content/uploads/2023/12/Rectangle-3481.png" />

                                <img className="absolute top-[339.8px] left-[0px] rounded-[15.58px] w-[235.5px] h-[274.8px] object-cover" alt=""
                            ...
                            <img className="absolute top-[14px] left-[1257px] w-[128.7px] h-[102.4px] object-contain" alt=""
                                src="https://smellmeloveme.shop/wp-content/uploads/2023/12/Vector-8-1-1.png" />

                            <img className="absolute top-[602px] left-[605px] w-[128.7px] h-[102.4px] object-contain" alt=""
                    ...
                    <div className="Personalized Memorial Website relative bg-[aliceblue] w-full h-[1142px] flex flex-col items-center justify-center py-0 px-[79.0335693359375px] box-border text-blue-grey-900">
                        <div className="relative w-[1243px] h-[712px]">
                            <div className="absolute top-[122px] left-[656px] w-[587px] h-[545.3px]">
                                <img className="absolute top-[0px] left-[176.2px] rounded-[19px] w-[410.7px] h-[545.3px] object-cover" alt=""
                                    src="https://smellmeloveme.shop/wp-content/uploads/2023/12/Rectangle-579.png" />

                                <img className="absolute top-[70.1px] left-[0px] rounded-[9px] w-[312.6px] h-[365.5px] object-contain" alt=""
                                ...
                                <div className="shrink-0 flex flex-col justify-start gap-[56px]">
                                    ...
                                    <div className="w-[606px] flex flex-col justify-start gap-[24px] text-lg text-darkslategray">
                                        <div className="self-stretch flex flex-row items-center justify-start gap-[7px]">
                                            <img className="relative w-[13px] h-[13px] object-cover" alt="" src="https://smellmeloveme.shop/wp-content/uploads/2023/12/Frame-43.png" />
                                        ...
                                        <div className="self-stretch flex flex-row justify-start gap-[7px]">
                                            <img className="relative w-[13px] mt-1 h-[13px] object-cover" alt="" src="https://smellmeloveme.shop/wp-content/uploads/2023/12/Frame-43.png" />
            ...
            <div
                className="mobile_version relative bg-basic-white w-full h-[7270px] overflow-hidden text-center text-5xl text-brand-primary font-sm-medium">
                <div className="absolute top-[0px] left-[0px] w-full h-[793px] overflow-hidden text-[28px] flex justify-center">
                    <img className="absolute top-[0px] w-full h-[793px] object-cover" alt=""
                    ...
                    <div className="absolute top-[65px] flex flex-col items-center justify-start gap-[32px]">
                        ...
                        <div
                            ...
                            <div className="shrink-0 flex flex-row items-center justify-start gap-[4.49px] text-xs text-brand-primary">
                                <img className="relative w-[30.1px] h-[30.1px] object-cover" alt="" src="http://cwc-shop.com/wp-content/uploads/2023/12/Group-1.png" />
                    ...
                    <div
                        ...
                        <img className="relative w-[350px] h-[247.8px] object-cover" alt="" src="https://smellmeloveme.shop/wp-content/uploads/2024/01/Group-1000000826.png" />
                    </div>
                    {/* <div className="absolute top-[0px] left-[0px] w-[375px] h-[94px] text-mini text-light-text-color">
                        <div className="absolute top-[64px] left-[20px] w-[335px] flex flex-row items-center justify-between">
                            <img className="relative w-[187px] h-[30px] object-cover" alt="" src="/-1@2x.png" />
                            <div className="shrink-0 flex flex-row items-center justify-start gap-[16px]">
                                <div className="shrink-0 flex flex-row items-center justify-start gap-[16px]">
                                    <div className="shrink-0 flex flex-row items-center justify-start">
                                        <img className="relative w-6 h-6 overflow-hidden shrink-0 object-cover" alt="" src="/gift@2x.png" />
                                    </div>
                                    <img className="relative w-5 h-5 overflow-hidden shrink-0 object-cover" alt="" src="/firssearch@2x.png" />
                                </div>
                                <img className="relative w-6 h-6 overflow-hidden shrink-0 object-cover" alt=""
                        ...
                        <div className="absolute top-[0px] left-[calc(50%_-_187.5px)] w-[375px] h-12">
                            <div className="absolute top-[19.3px] right-[20.4px] w-[24.3px] h-[11.3px]">
                                ...
                                <img className="absolute top-[3.7px] right-[0px] w-[1.3px] h-1 object-cover opacity-[0.4] mix-blend-normal"
                                    alt="" src="/cap@2x.png" />
                                <div className="absolute top-[2px] right-[4.3px] rounded-[1.33px] bg-light-text-color w-[18px] h-[7.3px]" />
                            </div>
                            <img className="relative w-[14.7px] h-[11px] object-cover" alt="" src="/wifi@2x.png" />
                            <img className="relative w-[16.3px] h-[10.7px] object-cover" alt="" src="/cellular-connection@2x.png" />
                        ...
                        <div className="shrink-0 flex flex-col items-start justify-start gap-[56px] text-5xl">
                            <div className="shrink-0 flex flex-col items-center justify-start gap-[32px]">
                                <div className="relative w-[214.6px] h-[205px]">
                                    <img className="absolute top-[132.6px] left-[0px] w-[94.3px] h-[72.4px] object-cover" alt=""
                        ...
                        <div className="shrink-0 flex flex-col items-start justify-start gap-[24px] text-xl text-blue-grey-800">
                            <div className="relative rounded-2xl bg-[white] w-[335px] h-[488px]">
                                <div
                                    ...
                                    <img className="relative w-12 h-12 object-cover" alt="" src="https://smellmeloveme.shop/wp-content/uploads/2023/12/Frame-2024.png" />
                                    <div className="self-stretch flex flex-col items-center justify-start gap-[24px]">
                                        <div className="self-stretch flex flex-col items-center justify-start gap-[24px]">
                            ...
                            <div className="relative rounded-2xl bg-[white] w-[335px] h-[488px]">
                                <div
                                    className="absolute top-[calc(50%_-_180px)] left-[calc(50%_-_147.5px)] w-[295px] flex flex-col items-center justify-start gap-[24px]">
                                    <img className="relative w-12 h-12 object-cover" alt="" src="https://smellmeloveme.shop/wp-content/uploads/2023/12/Frame-2024-1.png" />
                                    <div className="self-stretch flex flex-col items-center justify-start gap-[24px]">
                                        <div className="self-stretch flex flex-col items-center justify-start gap-[24px]">
                                            <div className="self-stretch flex flex-col items-center justify-start gap-[20px]">
                                                <div className="text_base_subhead_resp self-stretch relative leading-[26px] font-semibold">
                ...
                <div className="flex justify-center">
                    <div className="absolute top-[4351px] flex flex-col items-center justify-start gap-[48px] text-left">
                        <div className="relative w-[162.7px] h-[191.2px]">
                            <img className="absolute top-[17.5px] left-[24.4px] rounded-[6.64px] w-[121.5px] h-[153.8px] object-cover"
                                alt="" src="https://smellmeloveme.shop/wp-content/uploads/2023/12/Rectangle-3480.png" />
                            <img className="absolute top-[0px] left-[97.2px] rounded-[6.64px] w-[65.6px] h-[72.8px] object-cover" alt=""
                                src="https://smellmeloveme.shop/wp-content/uploads/2023/12/Rectangle-3481.png" />
                            <img className="absolute top-[105.7px] left-[0px] rounded-[6.64px] w-[73.3px] h-[85.5px] object-cover" alt=""
                                src="https://smellmeloveme.shop/wp-content/uploads/2023/12/Rectangle-3482.png" />
                        </div>
                        <div className="shrink-0 flex flex-col items-center justify-start gap-[32px]">
                            <div className="shrink-0 flex flex-col items-center justify-start gap-[24px]">
                        ...
                        <div className="self-stretch flex flex-col items-start justify-start gap-[16px]">
                            <div
                                ...
                                <div className="flex flex-row items-center justify-start gap-[14px]">
                                    <img className="relative w-6 h-6 object-cover" alt="" src="/icon@2x.png" />
                    ...
                    <div
                        ...
                        <div className="shrink-0 flex flex-col items-center justify-start gap-[32px]">
                            <div className="relative w-[203.4px] h-[189px]">
                                <img className="absolute top-[0px] left-[61.1px] rounded-[6.58px] w-[142.4px] h-[189px] object-cover" alt=""
                                    src="https://smellmeloveme.shop/wp-content/uploads/2023/12/Rectangle-579.png" />
                                <img className="absolute top-[24.3px] left-[0px] rounded-[3.12px] w-[108.3px] h-[126.7px] object-contain"
